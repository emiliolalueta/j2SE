...
public class  PantallaBajasCliente extends JPanel implements ActionListener, TableModelListener{
...
public ResultSet resulta;
 ...
 public PantallaBajasCliente(){	 
		...
		lblbienvenida=new JLabel("BAJAS DE CLIENTES");lblbienvenida.setBounds(600, 10, 200, 30);mainPanel.add(lblbienvenida);
...
public static void main(String[] args) {
	PantallaBajasCliente pan=new PantallaBajasCliente();
}

...
public class  PantallaAltasCliente00 extends JPanel implements ActionListener, TableModelListener{
...
public static void main(String[] args) {
	PantallaAltasCliente00 pan=new PantallaAltasCliente00();
}

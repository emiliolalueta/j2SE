...
<html>
    ...
    <body>
        ...
        tabla +="<tr><td>" + rs.getString("nombre")+"</td><br></tr>";
        //<td>rs.getString("imagen_cliente")</td>
        tabla +="<tr><th>Direccion</th>" + "<td>" + rs.getString("direccion")+ "</td>" + "<td><img src='img/CLIENTES/" + rs.getString("imagen_cliente")+ "'></td> </tr>";
